...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        try {
            ball = new ImageIcon("src/zetcode/dot.png").getImage();
            apple = new ImageIcon("src/zetcode/apple.png").getImage();
            head = new ImageIcon("src/zetcode/head.png").getImage();
        } catch (Exception e) {
    ...
    private void gameOver(Graphics g) {
        ...
        g.drawString(restartMsg, (B_WIDTH - metr.stringWidth(restartMsg)) / 2, B_HEIGHT / 2 + 10);
    }
